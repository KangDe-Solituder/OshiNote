...
export const MOTION_TIMING: Record<UiMotionDuration, MotionTiming> = {
  ...
  fast: { micro: 0.07, viewEnter: 0.12, viewExit: 0.055, routeEnter: 0.15, routeExit: 0.06, routeOffset: 5 },
  normal: { micro: 0.13, viewEnter: 0.18, viewExit: 0.075, routeEnter: 0.22, routeExit: 0.08, routeOffset: 6 },
  slow: { micro: 0.2, viewEnter: 0.25, viewExit: 0.1, routeEnter: 0.32, routeExit: 0.11, routeOffset: 8 },
}
