...
export const MOTION_TIMING: Record<UiMotionDuration, MotionTiming> = {
  ...
  fast: { micro: 0.07, viewEnter: 0.12, viewExit: 0.055, routeEnter: 0.18, routeExit: 0.1, routeOffset: 7 },
  normal: { micro: 0.13, viewEnter: 0.18, viewExit: 0.075, routeEnter: 0.26, routeExit: 0.14, routeOffset: 9 },
  slow: { micro: 0.2, viewEnter: 0.25, viewExit: 0.1, routeEnter: 0.36, routeExit: 0.18, routeOffset: 12 },
}
