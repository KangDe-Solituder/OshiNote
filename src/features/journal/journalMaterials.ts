...
export const JOURNAL_MATERIALS: JournalMaterialDefinition[] = [
  ...
  sticker('ghost', 'misc', 'journalMaterials.ghost', 74, 78, -5, { icon: 'ghost', color: '#c9bce8' }),
  sticker('blood-handprint', 'misc', 'journalMaterials.bloodHandprint', 76, 78, 8, { icon: 'blood-handprint', color: '#b8434a' }),
  sticker('heart-arrow', 'live', 'journalMaterials.heartArrow', 78, 74, -6, { icon: 'heart-arrow', color: '#f06292' }),
  sticker('wooden-club', 'misc', 'journalMaterials.woodenClub', 76, 80, 6, { icon: 'wooden-club', color: '#a98a68' }),
  sticker('angel-wings', 'live', 'journalMaterials.angelWings', 82, 72, -4, { icon: 'angel-wings', color: '#a8c8f0' }),
  sticker('white-dress', 'live', 'journalMaterials.whiteDress', 74, 82, -4, { icon: 'white-dress', color: '#fffefa' }),
  sticker('hannya-mask', 'misc', 'journalMaterials.hannyaMask', 74, 80, -7, { icon: 'hannya-mask', color: '#f3d6aa' }),
  sticker('mini-4wd', 'misc', 'journalMaterials.mini4wd', 76, 76, 5, { icon: 'mini-4wd', color: '#e0704f' }),
